...
export const BINDING_PRICES = {
  ...
  'Spiral Binding': {
    'A4': [
      { min: 1, max: 25, price: 20 },
      { min: 26, max: 50, price: 25 },
      { min: 51, max: 100, price: 30 },
      { min: 101, max: 150, price: 35 },
      { min: 151, max: 200, price: 40 },
      { min: 201, max: 250, price: 50 },
      { min: 251, max: 300, price: 60 },
      { min: 301, max: 350, price: 70 },
      { min: 351, max: 400, price: 80 },
      { min: 401, max: 450, price: 90 },
      { min: 451, max: 500, price: 100 },
    ],
    'FS': [
      { min: 1, max: 50, price: 35 },
      { min: 51, max: 100, price: 40 },
      { min: 101, max: 150, price: 45 },
      { min: 151, max: 200, price: 50 },
      { min: 201, max: 250, price: 60 },
      { min: 251, max: 300, price: 70 },
      { min: 301, max: 350, price: 80 },
      { min: 351, max: 400, price: 90 },
      { min: 401, max: 450, price: 100 },
      { min: 451, max: 500, price: 110 },
    ],
  },
};
